...
\hypertarget{lecture-08-note}{%
\chapter{Lecture 08 Note}\label{lecture-08-note}}
...
\hypertarget{class-01-3}{%
\section{class 01}\label{class-01-3}}
...
\hypertarget{class-02-3}{%
\section{class 02}\label{class-02-3}}
...
\hypertarget{class-04-4}{%
\section{class 04}\label{class-04-4}}
...
\hypertarget{tools-for-high-throughput-data}{%
\chapter{Tools for High-throughput data}\label{tools-for-high-throughput-data}}

\hypertarget{high-throughput-genomic-data}{%
\section{High-throughput genomic data}\label{high-throughput-genomic-data}}

\includegraphics[width=7.29167in,height=\textheight]{images/12/ngs.png}
...
\includegraphics{images/12/env0.png}
...
\includegraphics{images/12/sra.png}
...
\includegraphics[width=7.29167in,height=\textheight]{images/04/geo_overview.jpg}
...
\includegraphics[width=7.29167in,height=\textheight]{images/12/ExpressionSet.png}
...
\FunctionTok{pData}\NormalTok{(mygse)}
\FunctionTok{fData}\NormalTok{(mygse)}
\FunctionTok{exprs}\NormalTok{(mygse)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=7.29167in,height=\textheight]{images/12/htanalysis.png}
...
\includegraphics{images/12/04-2.png}

\includegraphics{images/12/06.png}
...
\begin{figure}
\centering
\includegraphics{images/08/01.PNG}
...
\chapter{Significance test}\label{significance-test}}
...
\includegraphics{./images/09/01.png}
...
\includegraphics{./images/09/02.png}
...
\includegraphics{./images/09/03.png}
...
\begin{figure}
\centering
\includegraphics{./images/09/06.png}
\caption{page304}
\end{figure}
