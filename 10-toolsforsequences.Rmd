...
download.file(url = "https://github.com/greendaygh/kribbr2022/blob/main/yeast1orf.cds", destfile = "covid_table.csv")
...
##
require(genbankr)
recs <- entrez_fetch(db="nuccore", id=covid19$gbacc[1], rettype="gb")
